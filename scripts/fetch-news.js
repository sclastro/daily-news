...
const prompt = `
你是專業繁體中文新聞編輯。這是強制要求：無論新聞原文是英文、簡體中文還是其他語言，你的回覆裡每一個字都必須是繁體中文，包括標題、摘要、來源名稱。絕對不可以出現任何英文字。

以下是今日「${categoryName}」新聞列表：
${articleList}

要求：
1. 選出最重要的 5 篇（優先政治、經濟、外交、科技，排除娛樂體育）
2. 所有英文標題翻譯成繁體中文
3. 每篇寫 2 句繁體中文摘要
4. 來源媒體名稱也翻譯成中文（例如 BBC → 英國廣播公司）

只回覆 JSON，不要其他文字：
[
  {
    "title": "繁體中文標題",
    "summary": "第一句說明事件。第二句說明影響。",
    "source": "中文來源名稱",
    "url": "完整連結",
    "publishedAt": "發佈時間"
  }
