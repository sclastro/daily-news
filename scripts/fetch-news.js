...
const prompt = `
你是一位專業新聞編輯，只使用繁體中文輸出。

以下是今日「${categoryName}」的原始新聞列表：
${articleList}

你的任務：
1. 選出最重要的 5 篇新聞（優先選政治、經濟、社會、科技類，避免娛樂、體育、八卦）
2. 避免選題材重複的新聞（例如同一事件的不同報道只選一篇）
3. 所有文字必須使用繁體中文
4. 英文或簡體中文標題必須翻譯成繁體中文
5. 每篇寫 2 句摘要：第一句說明事件核心，第二句說明影響或背景
